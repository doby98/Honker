...
public class Poker {	// 포커에 관한 전반적인 메서드와 멤버변수 
	...
	private String[] my_deck = new String[7]; 
	private int my_deck_count = 0;
	private static int myMoney = 0;
	private static int totalBet = 0;
	private int betMoney = 1000;
	private boolean betDie = false;
...
//		System.out.println("정렬 후 내 패 : " + Arrays.toString(this.getMy_deck()));
	...
	public void betting() {
		...
		default:
			System.out.println("잘못 입력하셨습니다. 베팅이 넘어갑니다.");
		}
